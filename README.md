...
> only on Patreon, via our $25 Tier. Feel free jo join us [There](https://patreon.com/XeroLinux) <sup>[**`Why Paid`**](https://github.com/adi1090x/adi1090x/blob/master/WHY.md)</sup>
-----------------------------------------------------------------
